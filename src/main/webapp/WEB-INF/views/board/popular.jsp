...
<div class="row justify-content-around">
  ...
  <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
    <a class="dropdown-item" href="/board/popular?page=${scri.page}&perPageNum=10&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=${scri.sort}">10개씩</a>
    <a class="dropdown-item" href="/board/popular?page=${scri.page}&perPageNum=20&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=${scri.sort}">20개씩</a>
    <a class="dropdown-item" href="/board/popular?page=${scri.page}&perPageNum=30&searchType=${scri.searchType}&keyword=${scri.keyword}&sort=${scri.sort}">30개씩</a>
  </div>
	...
	<%@include file="../includes/listCategory.jsp"%>
					...
					<c:if test="${pageMaker.prev}">
						<li class="page-item"><a class="page-link"
							href="/board/popular${pageMaker.makeSearch(pageMaker.startPage - 1)}">이전</a></li>
					</c:if>
					...
					<c:forEach begin="${pageMaker.startPage}"
						...
						<li
							...
							class="page-link" href="/board/popular${pageMaker.makeSearch(idx)}">${idx}
						</a></li>
					</c:forEach>

					<c:if test="${pageMaker.next && pageMaker.endPage > 0}">
						<li class="page-item"><a class="page-link"
							href="/board/popular${pageMaker.makeSearch(pageMaker.endPage + 1)}">다음</a></li>
					</c:if>
				</ul>
				...
				<button type="button" onclick="location.href='/board/writeView'" class="btn btn-success mb-3"> <i class="fas fa-edit mr-2"></i>새 글 작성</button>
